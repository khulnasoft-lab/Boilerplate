...
const khulnasoft-lab = require('khulnasoft-lab')
...
const client = khulnasoft-lab.createClient({
  // This is the space ID. A space is like a project folder in KhulnaSoft terms
  space: SPACE_ID,
  // This is the access token for this space. Normally you get both ID and the token in the KhulnaSoft web app
  accessToken: ACCESS_TOKEN
})

console.log(chalk.green.bold('\nWelcome to the KhulnaSoft JS Boilerplate\n'))
console.log('This is a simplified example to demonstrate the usage of the KhulnaSoft CDA\n')
...
function runBoilerplate () {
  ...
  .then(() => {
    ...
    console.log(chalk.cyan('https://khulnasoft.com/developers/docs/javascript/tutorials/using-js-cda-sdk/\n'))
  })
  .catch((error) => {
...
// Load all Content Types in your space from KhulnaSoft
...
// Load all entries for a given Content Type from KhulnaSoft
